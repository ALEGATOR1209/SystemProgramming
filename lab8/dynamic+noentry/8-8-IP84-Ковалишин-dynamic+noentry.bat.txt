@echo off
    set filename="8-8-IP84-Ковалишин-main-dynamic"
    if exist "%filename%.obj" del "%filename%.obj"
    if exist "%filename%.exe" del "%filename%.exe"

    set libname="8-8-IP84-Ковалишин-lib-noentry"
    ...
    \masm32\bin\Link.exe /OUT:"%libname%.dll" /DLL /EXPORT:calc /NOENTRY "%libname%.obj"
