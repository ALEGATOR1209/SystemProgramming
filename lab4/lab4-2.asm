...
.data
    msg_title           EQU "À‡·‡ 4 (2)"
    msg_pass            EQU "¬‚Â‰≥Ú¸ Ô‡ÓÎ¸, ·Û‰¸ Î‡ÒÍ‡:"
    msg_data_title      EQU "Œ—Œ¡»—“≤ ƒ¿Õ≤:"
    msg_data_name       EQU "œ≤¡ -  Œ¬¿À»ÿ»Õ Œ. ﬁ."
    msg_data_birthday   EQU "ƒ¿“¿ Õ¿–Œƒ∆≈ÕÕﬂ - 12.09.2001"
    msg_data_num        EQU "ÕŒÃ≈– «¿À≤ Œ¬ » - 8410"
    msg_error           EQU 10, "ÕÂÔ‡‚ËÎ¸ÌËÈ Ô‡ÓÎ¸, ÒÔÓ·ÛÈÚÂ ˘Â ‡Á!", 0
    password            DB "bsd~}d"
    passKey             DB 12h
    passLen             DD 6
